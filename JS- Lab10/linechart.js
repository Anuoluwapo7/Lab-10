...
var myChart = new Chart(ctx, {
    ...
    data: {
...

        {
            ...
            fill: true,
            borderColor: 'rgba(170, 122, 78)',
            backgroundColor: 'rgba(170, 122, 78,0.1)',
            tension: 0.1},

        {
            ...
            fill: true,
            borderColor: 'rgba(170, 122, 150)',
            backgroundColor: 'rgba(170, 122, 150, 0.1)',
            tension: 0.1},
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Largest Countries Life Expectancy Over Time',
                font: {
                    size: 18
                }
            },
            subtitle: {
                display: true,
                text: 'The largest countries in the world life expectancies significantly change over two plus centuries.'
            }
        },
        scales: {
            y: {
