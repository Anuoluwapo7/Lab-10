...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            ...
            subtitle: {
                display: true,
                text: 'The Gross Domestic Product (GDP) indicates the vitality of national and world-wide economies. The following regions are reflected in the visualization.'
            }
        },
        scales: {
            y: {
